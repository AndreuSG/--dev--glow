    ...
    <section className="py-20 px-4 bg-[#F7F3EE]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12">
        <div className="flex-1">
          ...
          <p className="text-xl text-[#4A3F35]/90 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 text-[#4A3F35]">
              ...
              <span className="text-base">+34 601 99 52 34</span>
            </div>
            <div className="flex items-center gap-4 text-[#4A3F35]">
              <Mail className="w-6 h-6" />
              <span className="text-base">glowesteticaavanzada@gmail.com</span>
            </div>
            <div className="flex items-center gap-4 text-[#4A3F35]">
              <MapPin className="w-6 h-6" />
              <span className="text-base">Calle Alberes 62, 17300 Blanes, Girona, España</span>
            </div>
            <div className="flex items-start gap-4 text-[#4A3F35]">
              <Clock className="w-6 h-6 mt-1" />
              <div>
                <div className="text-base">Lunes - Viernes: 9:00-13:00 | 15:00-19:00</div>
